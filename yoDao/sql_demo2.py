...
def sql_query():
    ...
    sql = 'select id, sub_summary from bus_user_yn where  sub_summary is not null and sub_summary != ""'
...
if __name__ == '__main__':
    ...
    for word in word_list:
        ...
        if name_trans != '':
            ...
            try:
                sql = 'update bus_user_yn set  sub_summary  = "{}" where id = "{}"'.format(test_all, sql_id)
                print(sql)

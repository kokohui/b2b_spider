...
def sql_query():
    ...
    sql = 'select id, detail  from bus_product_purchases_quality where  detail is not null and detail != "" and id > 9812'
...
if __name__ == '__main__':
    ...
    for word in word_list:
        ...
        try:
            sql = 'update bus_product_purchases_quality set  detail_yn  = "{}" where id = "{}"' .format(test_all, sql_id)
            print(sql)

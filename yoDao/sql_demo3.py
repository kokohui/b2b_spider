...
def sql_query():
    ...
    sql = 'select id, keywords from bus_product_purchases_yn where  keywords is not null and keywords != "" and id = 57'
...
async def main():
        ...
        for word in word_list:
            ...
            try:
                sql = 'update bus_product_purchases_yn set  keywords  = "{}" where id = "{}"'.format(test_all, sql_id)
                print(sql)
